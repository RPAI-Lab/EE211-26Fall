...
## 1. Ubuntu Dual-Boot Install (Do This Before Class)

> Do this over the weekend, before Week 2. Bring problems to class or office hours — don't struggle alone.

📄 [Ubuntu Dual-Boot Install Guide]({{ '/assets/lab/week2/ubuntu-dual-boot-install' | relative_url }})

## 2. Basic Shell Commands on Ubuntu
