...
> Last Update: 2026-9-20

<br>

> **Prerequisite**: You should already have ROS2 Humble installed — see [Week2, section 3. Install ROS2 Humble]({{ '/assets/lab/week2/week2-page' | relative_url }}#3-install-ros2-humble). If you're not done yet, finish that first before continuing below.
...
- (optional) More on `rqt` <span style="float: right;">📑 [See](https://docs.ros.org/en/humble/Concepts/Intermediate/About-RQt.html)</span>
...
- Create your first package <span style="float: right;">📑 [See](https://docs.ros.org/en/humble/Tutorials/Beginner-Client-Libraries/Creating-Your-First-ROS2-Package.html)</span>
